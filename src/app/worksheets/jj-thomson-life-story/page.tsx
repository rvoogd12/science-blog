  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold text-center mb-8 text-gray-900">The Life Story of J.J. Thomson: Biography, Electron Discovery, Cathode Ray Tube Experiment—Class 12</h1>
