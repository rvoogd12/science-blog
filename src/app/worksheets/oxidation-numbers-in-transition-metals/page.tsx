    ...
    try {
      const response = await fetch('/api/subscribe', {
        ...
        body: JSON.stringify({ 
          name, 
          email,
          groupId: 'oxidation-numbers-in-transition-metals'
        }),
      });
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold text-center mb-8 text-gray-900">The Oxidation Number of Transition Metals: How to Find Variable Oxidation States in Chemistry</h1>
