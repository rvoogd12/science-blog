    ...
    try {
      const response = await fetch('/api/subscribe', {
        ...
        body: JSON.stringify({ 
          name, 
          email,
          groupId: 'thermodynamics-chemistry-class-11'
        }),
      });
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold text-center mb-8 text-gray-900">Thermodynamics Chemistry Class 11: Crash Course on First Law of Thermodynamics, Enthalpy, Hess's Law</h1>
