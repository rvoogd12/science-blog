    ...
    try {
      const response = await fetch('/api/subscribe', {
        ...
        body: JSON.stringify({ 
          name, 
          email,
          groupId: 'why-transition-metals-are-coloured'
        }),
      });
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold text-center mb-8 text-gray-900">Why Transition Metals are Generally Coloured: Color by Transition Elements Explained for Chemistry</h1>
